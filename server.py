    ...
    def handle(self):
        ...
        if splitData[0] == b"GET":
            ...
            # empty homepage
                ...
                if TCPHandler.voting_alive:
                    ...
                    participants = str(
                        voting_info[6] + voting_info[8] + voting_info[10] + voting_info[12] + voting_info[14])
                    ...
                    template_dict = {
                        ...
                        "option_votes_3": str(voting_info[10]), "option_name_3": voting_info[9],
                        "option3_display": option3_display,
                        "option_votes_4": str(voting_info[12]), "option_name_4": voting_info[11],
            ...
            # profile page
                ...
                while True:
                    ...
                    if frame_data[0][4:] == "1000":
                        print("closed")
                        TCPHandler.websocket_connections.remove(self)
                        break
                        ...
                        new_payload = '0' + bin(len(json.dumps(json_message).encode()))[2:]
                        ws_frame += int(new_payload, 2).to_bytes(1, "big")
        ...
        # signup
            ...
            # profile edit post 
                ...
                cursor.execute(
                    "INSERT INTO voting(creator_username, vote_name, vote_description, photo, option_one_name, option_two_name, option_three_name, option_four_name, option_five_name) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                    (TCPHandler.username, vote_name, description, file_name, option_1, option_2, option_3, option_4,
                     option_5))
                connection.commit()
...
def find_image(parsed_body):
    image = parsed_body[
            parsed_body.find(blank_line_boundary) + len(blank_line_boundary):len(parsed_body) - len(new_line)]
    return image
